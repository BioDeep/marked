        ...
        htmlRenderer.prototype.code = function (code, infostring, escaped) {
            ...
            if (!lang) {
                if (this.options.addcodeTag) {
                    return "<pre><code>".concat(code, "</code></pre>");
                }
                else {
                    return "<pre>".concat(code, "</pre>");
                }
            }
            else {
                lang = this.options.langPrefix + markedjs.helpers.escape.doescape(lang, true);
                if (this.options.addcodeTag) {
                    return "<pre><code class=\"".concat(lang, "\">").concat(code, "</code></pre>\n");
                }
                else {
                    return "<pre class=\"".concat(lang, "\">").concat(code, "</pre>\n");
                }
            }
        };
        ;
